...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configProps.put("topic.creation.enable", true);
        configProps.put("topic.creation.default.replication.factor", 1);
        configProps.put("topic.creation.default.partitions", 1);
