...
import ru.yandex.practicum.practicum.infra.gateway.kafka.telemetry.event.MotionSensorAvro;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.collector.kafka.KafkaClientProducer;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.collector.dto.sensor.MotionSensorEvent;
...
public class MotionSensorEventHandler extends BaseSensorEventHandler<MotionSensorAvro> {
    ...
    protected MotionSensorAvro mapToAvro(SensorEvent event) {
        ...
        return MotionSensorAvro.newBuilder()
                ...
                .setMotion(motionSensorEvent.getMotion())  // Изменено с isMotion() на getMotion()
