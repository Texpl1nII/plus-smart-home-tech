package ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.processor;
...
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.kafka.KafkaClient;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.service.SnapshotHandler; // ← ПРАВИЛЬНЫЙ импорт!
