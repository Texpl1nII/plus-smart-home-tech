package ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.handler.hub;
...
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.handler.HubEventHandler;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.model.Scenario;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.repository.ScenarioActionRepository;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.repository.ScenarioConditionRepository;
import ru.yandex.practicum.practicum.infra.gateway.telemetry.analyzer.repository.ScenarioRepository;
